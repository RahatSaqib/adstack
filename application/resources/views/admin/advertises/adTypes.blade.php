                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Ad Type')"><span class="text--small badge font-weight-normal badge--warning">{{$type->type}}</span>
                                </td>
                                ...
                                <td data-label="@lang('Status')"><span class="text--small badge font-weight-normal {{ $type->status ==1 ?'badge--success':'badge--warning'}}">{{ $type->status == 1 ? 'Active':'Deactive' }}</span>
                                </td>
                                <td data-label="Action">
                                    <button type="button" class="btn btn-sm btn--primary edit" data-id="{{$type->id}}" data-name="{{$type->ad_name}}" data-type="{{$type->type}}" data-tp_cost="{{$type->tp_cost}}" data-width="{{$type->width}}" data-height="{{$type->height}}" data-slug="{{$type->slug}}" data-status="{{$type->status}}" data-isthirdparty="{{$type->is_third_party}}" data-impression="{{$type->is_impression}}" data-click="{{$type->is_click}}" data-adult="{{$type->is_adult}}" data-head="{{$type->head_script}}" data-script="{{$type->third_party_script}}">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="@lang('Type')" name="type" value="image" value="{{ old('type') }}" required readonly>
                        </div>

                        <div class="col-6">
                            <div class="form-group">
                                <label for="width">@lang('Width'): (<span class="text-danger">@lang('px')</span>)</label>
                                <input type="number" class="form-control" placeholder="@lang('width')" name="width" id="width" value="{{ old('width') }}" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="height"> @lang('Height'): (<span class="text-danger">@lang('px')</span>)</label>
                                <input type="number" class="form-control" placeholder="@lang('Height')" name="height" id="height" value="{{ old('height') }}" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="slug">@lang('Slug'): (<span class="text-danger">@lang('px')</span>)</label>
                            <input class="form-control" type="text" placeholder="@lang('Slug')" id="slug" name="slug" value="" required readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="width">@lang('Width'): (<span class="text-danger">@lang('px')</span>)</label>
                                <input type="number" class="form-control" placeholder="@lang('width')" name="width" id="widthU" value="{{ old('width') }}" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="height"> @lang('Height'): (<span class="text-danger">@lang('px')</span>)</label>
                                <input type="number" class="form-control" placeholder="@lang('Height')" name="height" id="heightU" value="{{ old('height') }}" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="slugU">@lang('Slug'): (<span class="text-danger">@lang('px')</span>)</label>
                            <input class="form-control" type="text" placeholder="@lang('Slug')" id="slugU" name="slug" value="" required readonly>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label for="add_tp_cost"> @lang('Third Party Cost'):</label>
                        ...
                        <div class="form-group">
                            <label for="add_type"> @lang('Type'):</label>
                            <select name="type" class="form-control" required id='ad-types'>
                                ...
                                <option value="third-party-link">Third Party Link</option>
                            </select>
                        </div>
                        <div class="form-group" id="head-field">
                            <label for="add_head">@lang('Head Tag'):</label>
                            <textarea class="form-control" type="text" placeholder="@lang('Head')" rows='3' id="add_head" name="head" value=""></textarea>
                        </div>

                        <div class="form-group" id="script-field">
                            <label for="add_script">@lang('Script'):</label>
                            <textarea class="form-control" type="text" placeholder="@lang('Script')" rows='8' id="add_script" name="script" value=""></textarea>
                        </div>
                        <div class="form-group" id="link-field">
                            <label for="add_link">@lang('Link'):</label>
                            <textarea class="form-control" type="text" placeholder="@lang('Link')" rows='2' id="add_link" name="link_script" value=""></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<!--edit modal-->
<div class="modal fade" id="editThirdPartyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label for="type"> @lang('Type'):</label>
                            <select name="type" class="form-control" value="{{old('type')}}" id="edit-adtypes" required>
                                <option value="adcash">Adcash All</option>
                                <option value="adsterra-banner">Adsterra Banner</option>
                                <option value="adsterra-social">Adsterra Social</option>
                                <option value="adcash-inpage">Adcash In-page Push</option>
                        ...
                        <div class="form-group" id="edit-head-field">
                            <label for="head">@lang('Head Tag'):</label>
                            <textarea class="form-control" type="text" placeholder="@lang('Head')" rows='3' id="head" name="head" value="{{ old('head') }}"></textarea>
                        </div>

                        <div class="form-group" id="edit-script-field">
                            <label for="script">@lang('Script'):</label>
                            <textarea class="form-control" type="text" placeholder="@lang('Script')" rows='8' id="script" name="script" value="{{ old('script') }}"></textarea>
                        </div>
                        <div class="form-group" id="edit-link-field">
                            <label for="link">@lang('Link'):</label>
                            <textarea class="form-control" type="text" placeholder="@lang('Link')" rows='2' id="link" name="link_script" value=""></textarea>
                        </div>
                        <div class="form-group">
                            <label> @lang('Status')</label>
                            <label class="switch m-0" for="statuss">
...
<button type="button" class="btn btn--primary addModal" data-toggle="modal"><i class="fas fa-plus"></i>
    @lang('Add new')
</button>
@endpush
@push('breadcrumb-plugins')
<button type="button" class="btn btn--primary addThirdPartyModal" data-toggle="modal"><i class="fas fa-plus"></i>
...
<script>
    ...
    $('#ad-types').on('change', function() {
        const linkField = document.getElementById('link-field')
        const headField = document.getElementById('head-field')
        const scriptField = document.getElementById('script-field')
        if ($(this).val() == 'third-party-link') {
    ...
    $('#edit-adtypes').on('change', function() {
        const linkField = document.getElementById('edit-link-field')
        const headField = document.getElementById('edit-head-field')
        const scriptField = document.getElementById('edit-script-field')
        if ($(this).val() == 'third-party-link') {
            scriptField.style.display = 'none';
            headField.style.display = 'none';
            linkField.style.display = 'block';
    ...
    $('.edit').on('click', function() {
        ...
        if (isThirdParty == 1) {
            ...
            if (type == 'third-party-link') {
                thirdparty.find('textarea[name=link_script]').val(script)
                scriptField.style.display = 'none';
                headField.style.display = 'none';
                linkField.style.display = 'block';
            } else {
